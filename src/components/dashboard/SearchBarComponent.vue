...
<template>
  <form class="flex items-center max-w-sm mx-auto" @submit.prevent="search">
    <label for="simple-search" class="sr-only">Chercher un produit</label>
    <div class="relative w-full">
      <div v-if="searchTerm" @click="emit('reset-search-filter')" class="absolute inset-y-0 z-20 end-1/3 flex items-center ps-3 ">
