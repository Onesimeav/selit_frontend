...
<template>
  <div data-modal-target="popup-modal" data-modal-toggle="popup-modal">
    <div v-if="selectedProducts.length!=0" class="relative justify-items-end end-6 ">
      <button type="button" data-modal-target="popup-modal" data-modal-toggle="popup-modal"  class=" flex justify-around items-center border-none bg-red-700 rounded-lg px-4 py-2 text-white font-poppins font-bold text-normal-text m-2">
        Supprimer
    ...
    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
      ...
      <tr>
        <th scope="col" class="p-4">
          <div class="flex items-center">
            <input @input="allProductCheckbox" id="checkbox-all-search" type="checkbox" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
      ...
      <tr v-for="(product,index) in products.data" :key="index" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600" >
        ...
        <td class="px-6 py-8 flex justify-around">
          ...
          <button @click="productCheckbox(product.id)" data-modal-target="popup-modal" data-modal-toggle="popup-modal">
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
      <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
        ...
        <div class="p-4 md:p-5 text-center">
          ...
          <button @click="deleteProducts" data-modal-hide="popup-modal" type="button" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center">
            Supprimer
          </button>
